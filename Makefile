...
deploy-account :; FOUNDRY_PROFILE=${chain} forge script ${contract} --rpc-url ${chain} $(if ${dry},--sender 0x25F2226B597E8F9514B3F68F00f494cF4f286491 -vvvv, --account ${account} --verify --verifier etherscan -vvvv --slow --broadcast)
